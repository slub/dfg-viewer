...
class tx_dfgviewer_sru_eid extends tslib_pibase {
	...
	public function main($content = '', $conf = array ()) {
		...
		$url = t3lib_div::_GP('sru') . '?operation=searchRetrieve&version=1.2&startRecord=1&maximumRecords=10&amp;recordSchema=dfg-viewer/pagequery=' . urlencode(t3lib_div::_GP('q'));
