...
use Slub\Dfgviewer\Validation\Mods\PhysicalDescriptionValidator;

class PhysicalDescriptionValidatorTest extends AbstractModsValidatorTest
{
    /**
    ...
    {
        return new PhysicalDescriptionValidator();
    }
}
