...
/*!
    ...
    Custom scripts
    ------------------------
    DFG viewer script for website only
...
$(document).ready(function() {
    ...
    // check scrolling for sticky nav on homepage
    if($('body.website.home')[0]) {
...
/*!
    ...
    Components
    ------------------------
    DFG viewer script for components on website
...
const dfgviewerValidationForms = document.querySelectorAll('.dfgviewer-validation form');

dfgviewerValidationForms.forEach((validationForm) => {
    validationForm.addEventListener("submit", function (event) {
        ...
        getData(this.action + '&url=' + encodeURI(document.getElementById("url").value)).then(data => {
