...
/**
 * The validator validates against the rules outlined in chapter 2.12 of the MODS application profile 2.4.
 *
 * @package TYPO3
 ...
 * @access public
 */
class IdentifierValidator extends AbstractModsValidator
{
