...
/**
 * The validator validates against the rules outlined in chapter 2.5 of the MODS application profile 2.4.
 *
 * @package TYPO3
 ...
 * @access public
 */
class LanguageValidator extends AbstractModsValidator
{
